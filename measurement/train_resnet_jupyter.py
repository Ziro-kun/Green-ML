...
def run_heavy_training(epochs=1, batch_limit=100, project_name="ResNet18-Jupyter-Test"):
    """
    주피터 노트북에서 호출 가능한 무거운 학습 함수입니다. 
    기본적으로 ResNet-18 모델과 CIFAR-10 데이터셋을 사용합니다.
    """
